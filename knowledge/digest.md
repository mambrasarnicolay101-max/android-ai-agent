...
- `CVE-2026-46442` CVSS:9.9 — Flowise is a drag & drop user interface to build a customized large language model flow. Prior to ve
- `CVE-2026-44748` CVSS:9.9 — SAP NetWeaver Application Server ABAP and ABAP Platform allows an authenticated attacker with normal
- `CVE-2023-54352` CVSS:9.8 — WordPress Seotheme contains a remote code execution vulnerability that allows unauthenticated attack
- `CVE-2024-58348` CVSS:9.8 — WordPress Background Image Cropper version 1.2 contains a remote code execution vulnerability that a
- `CVE-2024-58349` CVSS:9.8 — WordPress Theme Travelscape 1.0.3 contains an arbitrary file upload vulnerability that allows unauth

## CISA Known Exploited (30 entries)
- `CVE-2026-35273` [Oracle  PeopleSoft Enterprise PeopleTools] Added:2026-06-12
- `CVE-2026-10520` [Ivanti Sentry] Added:2026-06-11
- `CVE-2026-11645` [Google Chromium V8] Added:2026-06-09
...
- [InterleaveThinker: Reinforcing Agentic Interleaved Generation](http://arxiv.org/abs/2606.13679v1) — Recent image generators have demonstrated impressive photorealism and instruction-following capabili
- [SpatialClaw: Rethinking Action Interface for Agentic Spatial Reasoning](http://arxiv.org/abs/2606.13673v1) — Spatial reasoning, the ability to determine where objects are, how they relate, and how they move in
...
- PicoCTF (authorized) — https://picoctf.org
- CTFlearn (authorized) — https://ctflearn.com
- OverTheWire (authorized) — https://overthewire.org
- DVWA (Local) (local_only) — localhost
